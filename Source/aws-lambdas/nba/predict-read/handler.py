"""
NBA read-only serving Lambda. Triggered by API Gateway behind the Cognito
authorizer.
...
logger = logging.getLogger("nba-predict-read")
...
def lambda_handler(event, context):
    # EventBridge Scheduler warmup ping (scheduler-nba-predict-read-
    ...
    try:
        ...
        if resource == "/nba/predictions/events/{event_id}/players/{entity_id}":
