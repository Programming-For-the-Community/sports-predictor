...
class TestExtractLiveState:
    def test_parses_a_live_game(self):
        espn_event = _espn_event("1", state="in", completed=False, detail="Q3 04:12", home_score="88", away_score="82")

        state = live_scores._extract_live_state(espn_event)

        assert state == {"live": True, "completed": False, "detail": "Q3 04:12", "home_score": 88, "away_score": 82}
