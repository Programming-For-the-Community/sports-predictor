...
# Standalone Fargate task. Reads event_features.parquet, trains the
# NCAAFB win-probability model against the training harness's
# hyperparameter search, and writes a versioned artifact to the model
# artifacts bucket.
#
